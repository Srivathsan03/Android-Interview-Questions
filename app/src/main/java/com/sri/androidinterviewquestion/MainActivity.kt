...
fun Questions(viewModel: MainViewModel) {
    val interviewQuestionsList = viewModel.interviewQuestionsListStateFlow.collectAsState().value
...
@Composable
fun InterviewQuestionsView(interviewQuestions: InterviewQuestions) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .padding(16.dp),
